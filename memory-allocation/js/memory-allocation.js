...
class Simulation extends Application {
    constructor({ element, id, allocatorCode = null, calls = null }) {
        ...
        if (typeof window !== "undefined") {
            window.__memoryAllocationSimulations ||= [];
            window.__memoryAllocationSimulations[id] = this;
        }
    };
    ...
    async init() {
        ...
        if (this.slider) {
            ...
            this.textPrev.style.fontFamily = "var(--code-font)";
            ...
            this.text.style.fontFamily = "var(--code-font)";
            ...
            this.textNext.style.fontFamily = "var(--code-font)";
...
I'm guessing that if you're seeing this, you're interested in how this post was
made. The code is vanilla JavaScript, so it should be relatively easy to
poke around here in your browser.

This local replica keeps the original vanilla JavaScript structure intact, so
the runtime should still be easy to inspect in your browser tools.
    `;
    console.log(msg);
});
