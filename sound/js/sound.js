 ...
 `;
    ...
    function Drawer(container, mode) {
        ...
        this.repaint = function(dt) {
            ...
            if (mode === "particles1" || mode === "particles2" ||
                ...
                ctx.globalAlpha = 1;
                ctx.font = font_size * 2.5 + "px sans-serif";
                ...
                ctx.font = ceil(fs) + "px sans-serif";
                ...
                if (microphone_source) {
                    ...
                    ctx.font = ceil(font_size * 0.7) + "px sans-serif";
                    ...
                    ctx.translate(width * 0.5, height * 0.5);
                    ctx.font = ceil(font_size * 1.5) + "px sans-serif";
                ...
                ctx.font = ceil(font_size * 0.8) + "px sans-serif";
        ...
        if (load_text)
            document.fonts.load("10px sans-serif").then(function() { request_repaint() });
    ...
    function KeyBoard(container, drawer_container, drawer) {
        ...
        for (let i = 0; i < 3; i++) {
            ...
            if (!touch_size)
                button_label.innerHTML = keyboard_letters[i].toUpperCase();
