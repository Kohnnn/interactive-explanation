...
function Sidebar(loopy){
	...
	(function(){
		...
		page.addComponent(new ComponentHTML({
			...
			"<b style='font-size:1.4em'>LOOPY</b><br>draw, tune, and run feedback systems<br><br>"+
			...
			"<span class='mini_button' onclick='publish(\"modal\",[\"credits\"])'>about</span><br><br>"+
			...
			"<hr/><br>"+
			"<span style='font-size:0.85em'>Try a reinforcing loop, then flip one arrow to see how a balancing loop behaves.</span>"
