    ...
    function Drawer(container, mode) {
        ...
        this.repaint = function (dt) {
            ...
            function draw_pressure_gauge(s, angle, hose) {
                ...
                ctx.restore();
                ctx.font = "500 " + s * 0.13 + "px sans-serif";
                ...
                ctx.font = "500 " + s * 0.05 + "px sans-serif";
            ...
            if (mode === "syringe" || mode === "syringe_pressure") {
                ...
                ctx.font = "500 " + s * 0.6 + "px sans-serif";
                ctx.fillText("h", -3 * s, -2.5 * s + font_size * 0.4);
                ctx.font = "500 " + s * 0.3 + "px sans-serif";
                ...
                if (weight_h > 0) {
                    ...
                    ctx.fillStyle = "#333";
                    ctx.font = "500 " + w * 0.21 + "px sans-serif";
                ...
                if (mode !== "brick_container") {
                    ...
                    ctx.font = "500 " + s * 0.06 + "px sans-serif";
        ...
        if (load_text)
            document.fonts.load("500 10px sans-serif").then(function () { request_repaint() });
