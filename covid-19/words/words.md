<div class="section">
    <div>
		...
		<div style="font-weight: 100;top: 189px;left: 10px;font-size: 19px;line-height: 21px;">
			...
			<br>
			Interactive guide with playable epidemic simulations.
		</div>
	</div>
</div>
...
A lot of us are worried. That's why this guide uses **playable simulations**, so that *you* can channel that worry into understanding:
...
Heck no! **[DP-3T](https://github.com/DP-3T/documents#decentralized-privacy-preserving-proximity-tracing)**, a team of epidemiologists & cryptographers, is *already* making a contact tracing app – with code available to the public – that reveals **no info about your identity, location, who your contacts are, or even *how many contacts* you've had.**

Here's how it works:

![](pics/dp3t.png)

(Further context on privacy-preserving contact tracing appears in the footnote below:[^dp3t_details])
