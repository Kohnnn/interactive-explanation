...
window.Captions = {
	"en": {
		...
		captions: {
			...
			"prop0": "Hi there,",
			"prop1": "this is an interactive explanation about neurons.",
			...
			"prop5": "Excuse me, I was talking... just kidding.",
			...
			"fear4": "and of...",
			"fear5": "holes.",
			"fear6": "I do not know why, but tightly clustered holes",
			"fear7": "just kind of creep me out, you know?",
			...
			"hebb7": "This is a rule of thumb neuroscientists use to describe how",
			...
			"hebb12": "Too slow! You did not click fast enough. Try again?",
			"hebb13": "Not close enough. Try a different pair of neurons.",
			"hebb14": "And that's how we learn!",
			"hebb15": "Of course, we do not learn that quickly in real life,",
			"hebb16": "I sped this simulation up, but still.",
			...
			"anti0": "Anyway, if that's how we learn, here's how we unlearn.",
			...
			"anti8": "That neuron did not have any connections.",
			"anti9": "You need to find one that's connected.",
			"anti10": "That neuron only has connections going to it, but not from it.",
			"anti11": "You need to find one that has connections from it.",
			"anti12": "Now wait for it...",
			"anti13": "And look! The connection's weaker.",
			"anti14": "Do that again, and this time, the connection will be totally gone.",
			"anti15": "And this unlearning rule is why, if you have a fear of dogs,",
			"anti16": "and you are exposed to friendly dogs over and over again,",
			...
			"ther0": "So now that you know how we learn and unlearn, let's revisit...",
			"ther1": "...this.",
			"ther2": "I want you to retrain this brain.",
			"ther3": "Rewire and reconnect each of these three things,",
			"ther4": "from feeling fear to feeling safe.",
			"ther5": "Rewiring yourself may cause anxiety in the short term...",
			"ther6": "...but it is so worth it in the long term.",
			"ther7": "One down, two more to go.",
			"ther8": "Two down, one more to go.",
			"ther9": "I still do not like holes.",
			"ther10": "And... you did it!",
			"ther11": "What you just did is called exposure therapy.",
			"ther12": "It is one of the most evidence-backed therapies out there",
			"ther13": "for treating specific phobias, PTSD, and other anxiety disorders.",

			"outro0": "Again, in real life, rewiring yourself is not easy, it is not quick,",
			"outro1": "but it can be done.",
			"outro2": "I promise you, it can be done.",
			"outro3": "",

			"cred11": "And remember, this interactive explanation was just an introduction.",
			"cred12": "So if you want to learn more, definitely check out the further reading",
			"cred13": "in the description below.",
			"cred14": "Or you could just play with the sandbox on the left,",
			"cred15": "because it is pretty fun.",
			"cred16": "Either way, thank you so, so much for exploring this.",
			"cred17": "",
			...
			"extra1": "but it is so worth it in the long term.",
			"extra2": "A conditioned fear.",
			"extra3": "The fear is extinguished.",
			"extra4": "Whoo!",
			"extra5": "Ta-dah.",
			"extra6": "The trick is to expose yourself to what you are afraid of,",
