...
(function () {
    ...
    function GLDrawer(scale, ready_callback) {
        ...
        download_file("../shared/mechanical-watch/models/watch_vertices.dat", function (buffer) {
        ...
        download_file("../shared/mechanical-watch/models/watch_indices.dat", function (buffer) {
